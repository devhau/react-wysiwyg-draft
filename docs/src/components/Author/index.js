  ...
  render() {
    return (
      <div className="author-root">
        I am <a target="_blank" href="https://twitter.com/devhau" rel="noopener noreferrer">nguyen van hau</a>, software developer based in New Delhi.
        ...
        I am freelancer. You can reach me for consulting work at nguyenvanhaudevß@gmail.com.
      </div>
    );
  }
}
