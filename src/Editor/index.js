...
class WysiwygEditor extends Component {
    ...
    if (this.props.mention) {
      decorators.push(
        ...getMentionDecorators({
          ...
          triggerChangeSuggestions: this.triggerChangeSuggestions,
  ...
  getSuggestions = () => this.props.mention && (isArray(this.props.mention.suggestions) ? this.props.mention.suggestions : this.props.mention.suggestions());

  triggerChangeSuggestions = () => this.props.mention && this.props.mention.func;
